...
(
  ...
  if [[ ! -x baseline-run.sh ]]; then
    curl https://raw.githubusercontent.com/nexis-netork/nexis/v"$baselineVersion"/run.sh -o baseline-run.sh
...
#
# Once https://github.com/nexis-netork/nexis/issues/7738 is resolved, remove
