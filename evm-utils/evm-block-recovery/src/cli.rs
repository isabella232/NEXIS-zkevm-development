/// CLI arguments and commands for the EVM block recovery tool.
/// Defines the default values, CLI options, and subcommands for finding,
/// restoring, checking, comparing, uploading, and repeating blocks.
...
/// CLI arguments and commands for the EVM block recovery tool.
/// Defines the subcommands for finding, restoring, checking, comparing,
/// uploading, and repeating blocks.
