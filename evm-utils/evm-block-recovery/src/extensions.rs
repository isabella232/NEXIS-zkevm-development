/// ParsedInstructions contains parsed EVM instructions from a block. It tracks
/// the number of different instruction types and whether there are only trivial
/// instructions.
