...
impl JsonRpcRequestProcessor {
    ...
    pub(crate) fn bank(&self, commitment: Option<CommitmentConfig>) -> Arc<Bank> {
        ...
        r_bank_forks.get(slot).unwrap_or_else(|| {
            ...
            // a slot.
            //
            // For more information, see https://github.com/nexis-netork/nexis/issues/11078
            warn!(
    ...
    pub fn get_confirmed_signatures_for_address(
        ...
        if self.config.enable_rpc_transaction_history {
            ...
            // https://github.com/nexis-netork/nexis/pull/10928
            let end_slot = min(
                end_slot,
...
pub mod rpc_accounts {
    ...
    pub trait AccountsData {
        ...
        // See https://github.com/nexis-netork/nexis-program-library/releases/tag/token-v2.0.0 for
        // program details
