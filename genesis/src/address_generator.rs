/// A struct for generating Solana addresses based on a provided base public key and program ID.
///
/// The AddressGenerator can be used to derive multiple addresses in a deterministic manner, by
/// incrementing an internal counter. This is useful for workflows like minting NFTs, where multiple
/// derived addresses are needed for each NFT minted.
